    ...
    \begin{enumerate}
            ...
            \begin{enumerate}
                ...
                \item[(ii)]
                    \begin{align*}
                        ...
                        \Leftrightarrow \ \ &0 % IST DAS RICHTIG?? -- Nenner wird unendlich groß, 0 ist  richtig.
                    \end{align*}
                \item[(iii)]
                    \begin{align*}
                        &\limp
        ...
        \item[\textbf{2.}]
			...
			\begin{enumerate}
			    ...
			    \item[(ii)]
			    	\begin{align*}
						 \frac{1}{1-x} \ = \ \frac{5}{8} \quad &\Leftrightarrow \quad 1  = \ (1-x) \ \cdot \ \frac{5}{8} \\[0,5cm]
						 \Leftrightarrow   \  1  = \frac{5}{8} \ - \ \frac{5}{8}x \quad &\Leftrightarrow \quad \frac{3}{8}  = \ -\frac{5}{8}x \quad \Leftrightarrow \quad \underline{x = -\frac{3}{5}}[0,2cm]
					\end {align*}	
			\end{enumerate}
            \end{enumerate}
        % Aufgabe 3

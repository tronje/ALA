    ...
    \begin{enumerate}
            ...
            \subitem(i)
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[domain=0:8, very thick, no marks, black] {x^2-x-6};
                    \end{axis}
                \end{tikzpicture}
                \end{center}
            \subitem(ii)
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[domain=0:8, very thick, no marks, black] {x^(1/3)};
                    \end{axis}
                \end{tikzpicture}
                \end{center}
            \subitem(iii)
                \begin{align*}
                    &&\int_1^3 \frac{1}{1+x^2} \mathrm{d}x \\
                    &=&[\tan^{-1}(x)]_1^3 \\
                    &=&\tan^{-1}(3) - \tan^{-1}(1)
                \end{align*}
                \begin{center}
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[domain=0:8, very thick, no marks, black] {1/(1+x^2)};
                    \end{axis}
                \end{tikzpicture}
                \end{center}
            \subitem(iv)
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[domain=0:8, very thick, no marks, black] {ln x};
                    \end{axis}
                \end{tikzpicture}
                \end{center}
            \subitem(v)
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[domain=0:8, very thick, no marks, black] {e^(-x)};
                    \end{axis}
                \end{tikzpicture}
                \end{center}
        ...
        \item[\textbf{3.}]
            ...
            \subitem (iii)
                ...
                % Probe:
                % \begin{align*}
                %     &\left(-\frac{1}{3} \cos(3x) \cdot x + \frac{1}{9} \sin(3x)\right)'&\\
                %     = \ &&
                % \end{align*}
            \subitem (iv)
                \begin{align*}
